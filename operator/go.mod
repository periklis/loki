...
require (
	...
	github.com/openshift/api v0.0.0-20230724190601-61a5301895a5 // release-4.13
...
require (
	github.com/openshift/cloud-credential-operator v0.0.0-20231002192639-6956fe53f3a2
