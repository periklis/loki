...
func AlertManagerSVCExists(ctx context.Context, stack lokiv1.LokiStackSpec, k k8s.Client) (bool, error) {
	if stack.Tenants == nil || (stack.Tenants.Mode != lokiv1.OpenShift && stack.Tenants.Mode != lokiv1.OpenshiftLogging && stack.Tenants.Mode != lokiv1.OpenshiftNetwork) {
		return false, nil
	}
...
func UserWorkloadAlertManagerSVCExists(ctx context.Context, stack lokiv1.LokiStackSpec, k k8s.Client) (bool, error) {
	if stack.Tenants == nil || (stack.Tenants.Mode != lokiv1.OpenShift && stack.Tenants.Mode != lokiv1.OpenshiftLogging) {
		return false, nil
	}
